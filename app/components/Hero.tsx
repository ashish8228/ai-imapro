    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="backdrop-blur-2xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/[0.1] rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-10 max-w-4xl mx-auto relative overflow-hidden"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className="backdrop-blur-2xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/[0.1] rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] p-6 hover:scale-105 transition-transform duration-300"
              >
                <div className="text-4xl md:text-5xl font-black bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-300 bg-clip-text text-transparent mb-2">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute top-32 left-16 w-20 h-20 backdrop-blur-2xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/[0.1] rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] flex items-center justify-center text-3xl"
          >
            🧠
          </motion.div>
